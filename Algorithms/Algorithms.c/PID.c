...
PID_t Chassis_Turning_PID = Chassis_Turning_PIDInit;
#undef Chassis_Turning_PIDInit

PID_t Chassis_Speed_PID = Chassis_Speed_PIDInit;
#undef Chassis_Speed_PIDInit

PID_t Chassis_Position_PID = Chassis_Position_PIDInit;
#undef Chassis_Position_PIDInit
