...
Motor_Init_t M3508_Chassis[2];
Motor_Init_t M3508_Fric_Wheel[2];

void M3508_Chassis_Get_Data(CAN_Export_Data_t RxMessage);
void M3508_Chassis_Send_Data(int16_t Motor_1_Current,int16_t Motor_2_Current);
...
void M3508_Chassis_Send_Data(int16_t Motor_1_Current,int16_t Motor_2_Current)
{
	CAN_Func.CAN_0x200_Send_Data(&hcan1,Motor_1_Current,Motor_2_Current,0,0);
}
