...
void Board_A_IMU_Read_Data(Board_A_IMU_t *Board_A_IMU)
{
	...
	Board_A_IMU->Calc_Data.Ax = Board_A_IMU->Raw_Data.Ax / 4096.0f * 9.81f;
	Board_A_IMU->Calc_Data.Ay = Board_A_IMU->Raw_Data.Ay / 4096.0f * 9.81f;
	Board_A_IMU->Calc_Data.Az = Board_A_IMU->Raw_Data.Az / 4096.0f * 9.81f;
