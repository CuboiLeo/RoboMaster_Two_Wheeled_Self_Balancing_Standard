 ...
 */
 ...
 void DR16_Data_Process(uint8_t *pData)
 {
	 ...
	 DR16_Export_Data.Remote_Control.Prev_Left_Switch = DR16_Export_Data.Remote_Control.Left_Switch;
	 DR16_Export_Data.Remote_Control.Left_Switch = ((pData[5] >> 4) & 0x000C) >> 2;
	 DR16_Export_Data.Remote_Control.Prev_Right_Switch = DR16_Export_Data.Remote_Control.Right_Switch;
